...
#     email: str = db.Column(db.String(200), nullable=False, unique=True) # todo verify email
#     first_name: str = db.Column(db.String(200), nullable=False)
#     last_name: str = db.Column(db.String(200), nullable=False)
